import { EntityItem, EntityNumItem } from '../models';
...
export function updateInCollection<T extends EntityItem>(
  item: T,
  items: T[],
): T[] {
...
export function isIdMatch<T extends EntityItem>(
  id: string | number,
  item: T,
): boolean {
...
export function getNextCollectionId<T extends EntityNumItem>(
  items: T[],
): number {
